...
taxa_geography = read.csv(paste0(config$run$runDir, "/output/", config$run$name, "_taxonomy_table_filtered_geography_16s.csv"))
...
sample_country = feature_table %>%
  ...
  mutate(country = case_when(
    grepl("PENN|PCI|Tissue", illumina_sample_id) ~ "US",
