...
study_system_lookup = data.frame(
  ...
  gbif_gid1_code = c("BRA.25_1", NA, "USA.5_1", "USA.39_1"),
...
# aggregate locally (replaces the SQL GROUP BY)
occ_data_summary = occ_data_raw %>%
  group_by(taxonKey, speciesKey, species, genus, family) %>%
  summarise(occ_count = n(), .groups = "drop")
