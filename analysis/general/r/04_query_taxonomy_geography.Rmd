...
taxa_out_file = here(run_dir, "output", paste0(config$run$name, "_taxonomy_table_gbif_occ.csv"))
...
```{r}
# load taxonomy table
taxa_raw = read_csv(here(run_dir, "output", paste0(config$run$name, "_taxonomy_table_filtered.csv")))
